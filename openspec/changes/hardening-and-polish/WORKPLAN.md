...
- [x] H-04 mensaje accionable si falla la carga del modelo · commit: 0200623
...
- [x] H-12 cerrar el micrófono al salir · commit: 3f2d32d
...
- [x] H-24 renombrar `_dispatch_naruto_seal` · commit: 71f0170 (nombre nuevo: `_dispatch_bound_event`, alias viejo conservado)
