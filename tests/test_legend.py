...
# Snapshot actualizado (C-03, WORKPLAN.md §10) para las 4 filas de swipe - el
# resto de las lineas no cambio ni un caracter, el padding (ljust) crecio
# porque la nueva fila mas larga ("Puño cerrado, movimiento rápido a la
# izquierda") supera a la anterior mas larga ("Índice + Medio arriba...").
_EXPECTED_TEXT = (
    "JARVIS — Gestos\n"
    "\n"
